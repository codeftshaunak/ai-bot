  ...
  return (
    <div className="flex h-screen bg-white dark:bg-gray-900">
      <div className="flex-1 flex flex-col">
        <div className="border-b border-gray-200 dark:border-gray-800 px-6 lg:px-8 py-4">
        ...
        <div className="flex-1 overflow-y-auto px-6 lg:px-8 py-6 lg:py-8 bg-gray-50 dark:bg-gray-900">
          {messages.length === 0 && (
