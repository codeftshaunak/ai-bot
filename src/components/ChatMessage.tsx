        ...
        <div
          className={`relative px-4 py-3 rounded-2xl shadow-sm ${
            message.sender === 'user'
              ...
              : 'bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-gray-800 dark:text-white border border-gray-200/50 dark:border-gray-700/50'
                ...
                <button
                  ...
                  className={`p-1.5 rounded-lg transition-all duration-200 ${
                    isPlaying
                      ...
                      : 'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400'
                  }`}
                  disabled={isPlaying}
